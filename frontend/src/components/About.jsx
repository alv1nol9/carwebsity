...
import { FaMapMarkerAlt, FaEnvelope, FaUsers, FaCarSide, FaHandshake } from "react-icons/fa";
...
export default function About() {
  return (
    <div className="about-section">
      ...
      <div className="about-card translucent-bg luxury-glow animate-fade-in">
        ...
        <p>
          Founded and owned by <span className="owner-name gold">Francis Mundia Nganga</span>, Valley Road Motors combines decades of automotive knowledge with a family touch. We believe in building long-term relationships, not just closing sales — and that’s what sets us apart.
        </p>
        ...
        <div className="about-highlight">
          At Valley Road Motors, you’re not just buying a car — you’re joining a family that values honesty, quality, and exceptional service. <br />
          <span className="gold">Visit us today and let’s get you on the road with confidence.</span>
        </div>
